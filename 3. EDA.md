...
Create a virtual environment. [No need to do it again, we have already done this in TUTORIAL1]
In this project all libraries should be installed inside the virtual environment (venv), and the project should run using that environment.
Example:
